...
export const BUTTON_VARIANTS = {
  ...
  secondary: "bg-white text-blue-600 hover:bg-blue-50 active:bg-blue-100 shadow-md hover:shadow-lg",
  ...
  language: "bg-indigo-600/40 backdrop-blur-sm text-white hover:bg-indigo-500/60 hover:scale-105 hover:shadow-lg hover:shadow-indigo-400/30 active:bg-indigo-700/50 active:scale-95 !w-8 !h-8 sm:!w-10 sm:!h-10 !rounded-xl focus:ring-2 focus:ring-indigo-300/60 focus:ring-opacity-50 focus:outline-none transition-all duration-300",
} as const;